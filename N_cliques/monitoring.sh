...
sar -u 1 > /home/ubuntu/neuroscience-on-FABRIC/N_cliques/profilingLogs/cpu_usage.log &
SAR_PID=$!
...
free -m |  grep "^ "
free -m | stdbuf -o0 grep '^ ' > /home/ubuntu/neuroscience-on-FABRIC/N_cliques/profilingLogs/mem_usage.log
free -m -s 1 | stdbuf -o0 grep '^Mem:' >> /home/ubuntu/neuroscience-on-FABRIC/N_cliques/profilingLogs/mem_usage.log &
FREE_PID=$!
printf "RAM utilization job ID is: %s\n" "$FREE_PID"


#start network monitoring 
echo "recv send" > /home/ubuntu/neuroscience-on-FABRIC/N_cliques/profilingLogs/networkLog.log
...
monitor_gpu() {
    local gpu_index=$1
    local log_file="/home/ubuntu/neuroscience-on-FABRIC/N_cliques/profilingLogs/gpu_usage.log"
    ...
    while true; do
        dstat --net --nocolor 1 5 | tail -n +3 >> /home/ubuntu/neuroscience-on-FABRIC/N_cliques/profilingLogs/networkLog.log
